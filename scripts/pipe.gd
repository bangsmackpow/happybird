...
func _draw():
	...
	draw_rect(Rect2(-half_w + 4, -viewport_height, PIPE_WIDTH - 8, viewport_height + top_pipe_bottom), PIPE_HIGHLIGHT, false, 1, true)

	draw_rect(Rect2(-half_w, bottom_pipe_top, PIPE_WIDTH, viewport_height), PIPE_COLOR)
	draw_rect(Rect2(-half_w + 4, bottom_pipe_top, PIPE_WIDTH - 8, viewport_height), PIPE_HIGHLIGHT, false, 1, true)

	draw_rect(Rect2(-cap_half, top_pipe_bottom - CAP_HEIGHT, PIPE_WIDTH + CAP_OVERHANG * 2, CAP_HEIGHT), PIPE_COLOR)
	draw_rect(Rect2(-cap_half + 3, top_pipe_bottom - CAP_HEIGHT + 3, PIPE_WIDTH + CAP_OVERHANG * 2 - 6, CAP_HEIGHT - 6), PIPE_HIGHLIGHT, false, 1, true)
	draw_rect(Rect2(-cap_half, top_pipe_bottom - CAP_HEIGHT, PIPE_WIDTH + CAP_OVERHANG * 2, CAP_HEIGHT), PIPE_DARK, false, 2, true)

	draw_rect(Rect2(-cap_half, bottom_pipe_top, PIPE_WIDTH + CAP_OVERHANG * 2, CAP_HEIGHT), PIPE_COLOR)
	draw_rect(Rect2(-cap_half + 3, bottom_pipe_top + 3, PIPE_WIDTH + CAP_OVERHANG * 2 - 6, CAP_HEIGHT - 6), PIPE_HIGHLIGHT, false, 1, true)
	draw_rect(Rect2(-cap_half, bottom_pipe_top, PIPE_WIDTH + CAP_OVERHANG * 2, CAP_HEIGHT), PIPE_DARK, false, 2, true)
